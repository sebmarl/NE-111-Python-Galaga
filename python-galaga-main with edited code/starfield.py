...
class StarField():
    def __init__(self):
        ...
        """ Creates the initialize funtcion for the starfield, setting the # of stars that appear SM """
    ...
    def create_stars(self, number_of_stars):
        ...
        return stars
        """ Sets the stars to cover the width of the screen in a random range using the random.randrange method SM """
    ...
    def render_stars(self, screen, star_collection, speed, size, color):
        for star in star_collection:
            ...
            """ sets the star speed and range over the screen SM """
